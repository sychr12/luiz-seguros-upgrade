...
const PRODUCTS: ProductItem[] = [
  {
    title: "Seguro Aluguel e Fiança",
    shortDesc: "Alugue sem fiador e sem depósito.",
    fullDesc:
      "O Seguro Aluguel substitui o fiador e o depósito caução na locação de imóveis residenciais e comerciais. Garante ao proprietário o recebimento dos aluguéis em caso de inadimplência do inquilino, além de cobrir danos ao imóvel e despesas jurídicas. Para o inquilino, é uma solução prática, rápida e econômica para fechar o contrato de locação sem precisar de um fiador.",
    icon: KeyRound,
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    title: "Seguro Garantia Geral",
    shortDesc: "Garantia para contratos e obrigações empresariais.",
    fullDesc:
      "O Seguro Garantia assegura o cumprimento de obrigações contratuais assumidas por uma empresa (tomadora) perante outra parte (segurada). É amplamente utilizado em contratos públicos e privados, licitações, concessões e parcerias. Substitui caução em dinheiro ou fiança bancária, liberando capital de giro para o tomador e oferecendo mais segurança ao beneficiário.",
    icon: ShieldCheck,
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    title: "Seguro Prestamista",
    shortDesc: "Proteja suas dívidas em caso de imprevistos.",
    fullDesc:
      "O Seguro Prestamista quita dívidas, financiamentos ou parcelas de cartão de crédito em caso de morte, invalidez permanente ou desemprego involuntário do contratante. Protege a família de obrigações financeiras inesperadas e garante que compromissos assumidos sejam honrados mesmo diante de imprevistos.",
    icon: HandCoins,
...
const STEPS: StepItem[] = [
  {
    ...
    desc: "Estamos preparados para atender todos os ramos de seguro garantia.",
  },
  {
    number: "2",
      ...
      <section id="inicio" className="relative h-130 md:h-150 overflow-hidden">
        ...
        >
          <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold max-w-4xl leading-tight mb-6">
            Garantia e segurança para seus contratos e compromissos.
          </h1>
          <p className="mt-4 text-zinc-200 max-w-2xl text-base md:text-2xl leading-relaxed">
            Parceria com as maiores seguradoras do mercado. Soluções de garantia
            sob medida para pessoas físicas e jurídicas.
          </p>
