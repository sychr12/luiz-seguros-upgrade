...
const PRODUCTS: ProductItem[] = [
  {
    ...
    shortDesc: "Realize o sonho da casa própria sem juros.",
    fullDesc:
      "O Consórcio de Imóveis pode ser usado para a compra de imóveis novos ou usados, residenciais, comerciais, de praia ou de campo. Você também pode reformar, construir ou comprar um terreno. Os grupos são formados com prazo de até 180 meses. A cada mês serão realizadas contemplações por meio de sorteio e lance — e você pode ainda utilizar 30% do valor do crédito nos lances.",
    icon: Home,
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    title: "Consórcio de Veículos",
    shortDesc: "Adquira seu carro com as melhores condições.",
    fullDesc:
      "O Consórcio de Veículos está consolidado no segmento de consórcio, com alto índice de satisfação entre seus clientes. Você tem até 80 meses para pagar e pode optar por créditos que variam conforme o bem escolhido: Automóveis • Caminhões e veículos utilitários • Motos • Embarcações • Aeronaves.",
    icon: Car,
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    title: "Consórcio de Equipamentos Profissionais",
    shortDesc: "Invista no seu negócio sem comprometer o caixa.",
    fullDesc:
      "O Consórcio de Equipamentos Profissionais é exclusivo para atender aos profissionais e estudantes que querem montar ou renovar seu negócio. Com ele você pode se planejar melhor, pois saberá exatamente quanto vai pagar todo mês. Os segmentos que podem se beneficiar são: Clínicas de saúde e estética • Academias • Oficinas mecânicas • Restaurantes e lanchonetes.",
    icon: Wrench,
    gradient: "from-orange-500 to-amber-500",
  },
  {
    title: "Consórcio de Eletroeletrônicos",
    shortDesc: "Tecnologia parcelada sem juros.",
    fullDesc:
      "O Consórcio de Eletroeletrônicos é um jeito leve de comprar tudo o que você precisa para sua casa ou escritório com planos que cabem no seu orçamento e parcelando em diversos meses, sem juros: iPhone • Smartphones • Computadores • Videogames • Câmeras profissionais.",
    icon: Smartphone,
    gradient: "from-violet-500 to-purple-500",
  },
  {
    title: "Consórcio de Serviços",
    shortDesc: "Pague serviços com planejamento e sem juros.",
    fullDesc:
      "O Consórcio permite contratar praticamente qualquer tipo de serviço, porque você usa o crédito para contratar a empresa prestadora do serviço: Festa de formatura • Festa de casamento • Cursos no exterior • Viagem de férias em família.",
    icon: HandCoins,
    gradient: "from-pink-500 to-rose-500",
  },
  {
    title: "Consórcio de Serviços Médicos",
    shortDesc: "Cuide da sua saúde com planejamento financeiro.",
    fullDesc:
      "O consórcio de serviços médicos é uma alternativa para quem busca acesso a tratamentos de saúde sem pagar altos valores. Com essa modalidade, é possível contribuir mensalmente e ser contemplado com consultas, exames, internações e cirurgias em uma rede credenciada. Opções disponíveis: Cirurgia plástica • Tratamentos odontológicos.",
    icon: Stethoscope,
    gradient: "from-sky-500 to-blue-500",
  },
  {
    title: "Consórcio de Motos",
    shortDesc: "Sua motocicleta sem entrada e sem juros.",
    fullDesc:
      "Adquira sua moto com planejamento financeiro e parcelas que cabem no bolso. Sem juros e sem entrada obrigatória, o consórcio de motos é a forma mais inteligente de realizar esse sonho com economia e tranquilidade.",
    icon: Bike,
    gradient: "from-indigo-500 to-blue-600",
  },
  {
    title: "Consórcio de Caminhões e Utilitários",
    shortDesc: "Renove sua frota com planejamento.",
    fullDesc:
      "Ideal para autônomos e empresas que precisam renovar ou ampliar a frota. Adquira caminhões, vans e veículos utilitários sem juros, com prazos flexíveis e créditos que se adaptam à sua necessidade.",
    icon: Truck,
...
const STEPS: StepItem[] = [
  {
    number: "1",
    title: "Defina seu Consórcio",
    desc: "Estamos preparados para atender todos os ramos de consórcio.",
  },
  {
    number: "2",
  ...
  },
  {
    number: "4",
    title: "Contrate",
    desc: "Tão logo você aceite a proposta, providenciamos seu consórcio rapidamente.",
  },
];
      ...
      <section id="inicio" className="relative h-130 md:h-150 overflow-hidden">
        ...
        >
          <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold max-w-4xl leading-tight mb-6">
            Realize seus sonhos sem juros e sem entrada.
          </h1>
          <p className="mt-4 text-zinc-200 max-w-2xl text-base md:text-2xl leading-relaxed">
            O consórcio é a forma mais inteligente de planejar a compra do que
            você deseja. Sem juros, sem entrada obrigatória e com parcelas que
            cabem no seu bolso.
          </p>
