...
const PRODUCTS: ProductItem[] = [
  {
    ...
    shortDesc: "Proteção para erros e omissões na prestação de serviços.",
    fullDesc:
      "O Seguro de Responsabilidade Civil Profissional (E&O) protege profissionais liberais e prestadores de serviço contra reclamações de clientes por erros, omissões ou falhas na execução de seus serviços. Indicado para advogados, contadores, consultores, engenheiros, arquitetos, médicos, entre outros. Cobre danos materiais, corporais e morais causados involuntariamente a terceiros no exercício da profissão.",
    icon: Briefcase,
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    title: "Seguro RC Corporativo",
    shortDesc: "Proteção para grandes empresas e grupos corporativos.",
    fullDesc:
      "O Seguro RC Corporativo oferece cobertura ampla para grupos empresariais e grandes companhias contra danos causados a terceiros em decorrência de suas atividades, produtos ou serviços. Inclui coberturas para danos materiais, corporais, morais, além de responsabilidade cruzada entre empresas do mesmo grupo. Ideal para multinacionais, holdings e empresas com operações complexas.",
    icon: Building2,
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    title: "Seguro RC Empresarial",
    shortDesc: "Proteção para empresas contra danos a terceiros.",
    fullDesc:
      "O Seguro de Responsabilidade Civil Empresarial protege a empresa contra reclamações por danos materiais, corporais ou morais causados a terceiros em decorrência das atividades do negócio. Cobre incidentes ocorridos nas dependências da empresa ou fora delas, desde que relacionados à operação. Essencial para qualquer empresa que deseja operar com segurança jurídica e financeira.",
    icon: ShieldCheck,
...
const STEPS: StepItem[] = [
  {
    ...
    desc: "Estamos preparados para atender todos os ramos de seguro responsabilidade.",
  },
  {
    number: "2",
      ...
      <section id="inicio" className="relative h-130 md:h-150 overflow-hidden">
          ...
          {HERO_IMAGES.map((img, index) =>
            index === currentHeroImage ? (
              ...
              >
                <Image
                  src={img}
                  alt="HB Seguros Responsabilidade Civil"
                  fill
                  priority={index === 0}
        ...
        >
          <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold max-w-4xl leading-tight mb-6">
            Proteja sua empresa e sua reputação contra imprevistos.
          </h1>
          <p className="mt-4 text-zinc-200 max-w-2xl text-base md:text-2xl leading-relaxed">
            Soluções de Responsabilidade Civil sob medida para profissionais,
            empresas e gestores. Parceria com as maiores seguradoras do mercado.
          </p>
