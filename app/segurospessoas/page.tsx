...
const PRODUCTS: ProductItem[] = [
  {
    ...
    shortDesc: "Proteção financeira em caso de acidentes.",
    fullDesc:
      "Cobertura em caso de morte acidental, invalidez permanente total ou parcial por acidente, despesas médico-hospitalares e assistência 24h. Ideal para quem busca proteção no dia a dia.",
    icon: ShieldAlert,
    gradient: "from-orange-500 to-red-500",
  },
  {
    title: "Seguro de Vida",
    shortDesc: "Proteção para você e sua família.",
    fullDesc:
      "Garante amparo financeiro à sua família em caso de morte natural ou acidental, com coberturas adicionais para doenças graves, invalidez e assistência funeral. Cuide de quem você ama.",
    icon: Heart,
    gradient: "from-rose-500 to-pink-500",
  },
  {
    title: "Previdência Privada",
    shortDesc: "Planejamento e segurança para o futuro.",
    fullDesc:
      "Complemente a aposentadoria do INSS com um plano de previdência privada. Escolha entre PGBL ou VGBL, com benefícios fiscais e rentabilidade competitiva para garantir seu futuro.",
    icon: TrendingUp,
      ...
      <section id="inicio" className="relative h-130 md:h-150 overflow-hidden">
        ...
        >
          <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold max-w-4xl leading-tight mb-6">
            Proteção inteligente para você e sua família.
          </h1>
          <p className="mt-4 text-zinc-200 max-w-2xl text-base md:text-2xl leading-relaxed">
            ...
            e soluções sob medida para a sua vida.
          </p>
