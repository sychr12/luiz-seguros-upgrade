...
const PRODUCTS: ProductItem[] = [
{
  ...
  shortDesc: "Proteção para o patrimônio da empresa.",
  fullDesc:
    "Cobertura contra incêndio, roubo, danos elétricos, responsabilidade civil e paralisação das atividades.",
  icon: Building2,
  gradient: "from-blue-600 to-cyan-500",
},
{
  title: "Seguro Riscos Diversos",
  shortDesc: "Coberturas específicas sob medida.",
  fullDesc:
    "Proteção para danos a terceiros, equipamentos, valores, mercadorias e eventos específicos.",
  icon: ShieldCheck,
  gradient: "from-emerald-500 to-teal-500",
},
{
  title: "Seguro de Vida Empresarial",
  shortDesc: "Segurança para seus colaboradores.",
  fullDesc:
    "Seguro coletivo com indenização por morte, invalidez ou doenças graves.",
  icon: HeartPulse,
...
const STEPS: StepItem[] = [
  {
    ...
    desc: "Estamos preparados para atender todos os ramos de seguro empresarial.",
  },
  {
    number: "2",
      ...
      <section id="inicio" className="relative h-130 md:h-150 overflow-hidden">
        ...
        >
          <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold max-w-4xl leading-tight mb-6">
            Proteção inteligente para a sua empresa crescer.
          </h1>
          <p className="mt-4 text-zinc-200 max-w-2xl text-base md:text-2xl leading-relaxed">
            ...
            e soluções sob medida para o seu negócio.
          </p>
