...
const PRODUCTS: ProductItem[] = [
  {
    ...
    shortDesc: "Dinheiro rápido para usar como quiser.",
    fullDesc:
      "O crédito é um empréstimo de dinheiro que pode ser utilizado de diversas formas: quitação de dívidas, investimentos em negócios, entre outras finalidades. O pagamento pode ser feito em parcelas fixas ou variáveis. Modalidades disponíveis: Empréstimo pessoal com cheque • Empréstimo pessoal com cartão de crédito • Empréstimo pessoal consignado • Empréstimo pessoal online.",
    icon: Banknote,
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    title: "Crédito Consignado",
    shortDesc: "Parcelas descontadas direto na folha ou INSS.",
    fullDesc:
      "É uma modalidade de empréstimo em que as parcelas são descontadas diretamente na folha de pagamento ou no benefício do INSS. Os limites de desconto são de até 30% para empréstimo consignado. Público-alvo: Aposentados e pensionistas do INSS • Servidores públicos • Funcionários de empresas privadas conveniadas.",
    icon: Receipt,
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    title: "Cartão de Crédito Consignado",
    shortDesc: "Crédito pré-aprovado com desconto em folha.",
    fullDesc:
      "É uma modalidade em que o valor mínimo da fatura é descontado diretamente na folha de pagamento ou no benefício do INSS. Os limites de desconto são de até 5% do valor do benefício. Público-alvo: Aposentados e pensionistas do INSS • Servidores públicos • Funcionários de empresas privadas conveniadas.",
    icon: CreditCard,
    gradient: "from-violet-500 to-purple-500",
  },
  {
    title: "Cartões de Crédito Parceiros",
    shortDesc: "Cartões com programas de pontos e benefícios exclusivos.",
    fullDesc:
      "Trabalhamos com cartões das principais seguradoras do mercado, cada um com vantagens únicas: Porto Seguro (pontos para descontos em seguros, estacionamentos credenciados, até 4 adicionais gratuitos) • Tokio Marine (recompensas a cada compra, parcelamento em 12x sem juros) • MAPFRE (pontos para descontos, assistência viagem gratuita) • SulAmérica (ofertas exclusivas em produtos e serviços) • Bradesco Seguros (assistência emergencial em viagens nacionais e internacionais).",
    icon: Wallet,
    gradient: "from-pink-500 to-rose-500",
  },
  {
    title: "Empréstimo Pessoal",
    shortDesc: "Crédito sem garantias, aprovação rápida.",
    fullDesc:
      "O empréstimo pessoal é uma modalidade de crédito direcionada para pessoas físicas que necessitam de dinheiro para realizar projetos pessoais ou quitar dívidas. Não requer apresentação de garantias como imóveis ou automóveis, e o valor é liberado rapidamente após análise de crédito. Modalidades: Empréstimo pessoal com cheque • Com cartão de crédito • Consignado • Online.",
    icon: HandCoins,
    gradient: "from-orange-500 to-amber-500",
  },
  {
    title: "Financiamento de Imóveis",
    shortDesc: "Realize o sonho da casa própria parcelado.",
    fullDesc:
      "O financiamento imobiliário permite a aquisição de um imóvel de maneira parcelada, com taxas de juros mais baixas e prazo estendido por vários anos. Modalidades disponíveis: Sistema de Financiamento Imobiliário (SFI) • Refinanciamento Imobiliário • Empréstimo com garantia de imóvel (home equity).",
    icon: Home,
    gradient: "from-teal-500 to-green-500",
  },
  {
    title: "Financiamento de Veículos",
    shortDesc: "Adquira seu veículo novo ou usado com parcelas fixas.",
    fullDesc:
      "Modalidade de crédito na qual é possível adquirir um automóvel novo ou usado, pagando em parcelas fixas. Normalmente o próprio veículo é utilizado como garantia da operação. Opções: CDC (Crédito Direto ao Consumidor) • Leasing / Arrendamento Mercantil • Refinanciamento de veículos • Alienação fiduciária • Financiamento com entrada facilitada • Financiamento com taxas reduzidas.",
    icon: Car,
    gradient: "from-indigo-500 to-blue-600",
  },
  {
    title: "Crédito para Empresas",
    shortDesc: "Capital de giro e investimento para o seu negócio.",
    fullDesc:
      "Somos especialistas em empréstimos e crédito e operamos com os principais bancos e financeiras do mercado. Nosso objetivo é garantir as melhores taxas e condições de negociação para pessoa jurídica. Oferecemos atendimento personalizado e auxiliamos em cada etapa, desde a análise de crédito até a contratação, com as melhores condições do mercado.",
    icon: BadgePercent,
...
const STEPS: StepItem[] = [
  {
    number: "1",
    title: "Defina seu Crédito",
    desc: "Estamos preparados para atender todos os ramos de crédito e financiamento.",
  },
  {
    number: "2",
  ...
  },
  {
    number: "4",
    title: "Contrate",
    desc: "Tão logo você aceite a proposta, providenciamos seu crédito rapidamente.",
  },
];
      ...
      <section id="inicio" className="relative h-130 md:h-150 overflow-hidden">
          ...
          {HERO_IMAGES.map((img, index) =>
            index === currentHeroImage ? (
              ...
              >
                <Image
                  src={img}
                  alt="HB Seguros Financiamentos e Créditos"
                  fill
                  priority={index === 0}
        ...
        >
          <h1 className="text-3xl md:text-6xl lg:text-7xl font-bold max-w-4xl leading-tight mb-6">
            Crédito e financiamento com as melhores taxas do mercado.
          </h1>
          <p className="mt-4 text-zinc-200 max-w-2xl text-base md:text-2xl leading-relaxed">
            Somos especialistas em crédito e operamos com os principais bancos e
            financeiras. Realize seus projetos com segurança e tranquilidade.
          </p>
