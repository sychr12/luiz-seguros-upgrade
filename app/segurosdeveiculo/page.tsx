...
const SocialLink = ({ Icon, href, color, hoverColor }: SocialLinkProps) => {
  ...
  //isso aqui e responsavel por criar o efeito de glow no icone, usando a cor de hover como base(kkkkk eu esqueci aonde eu tava usando isso, mas acho que era pra criar um efeito de glow no icone)
  return (
    <a
      href={href}
...
const PRODUCTS: ProductItem[] = [
  {
    title: "Seguro para Veículos",
    shortDesc: "Proteção contra colisões, roubos e danos.",
    fullDesc:
      "Cobertura completa contra colisões, roubo, furto, danos a terceiros e assistência 24h em todo o Brasil.",
    icon: Car,
    gradient: "from-blue-500 to-cyan-500",
  },
  {
    title: "Seguro Aeronaves",
    shortDesc: "Proteção para aviões e helicópteros.",
    fullDesc:
      "Cobertura contra danos físicos à aeronave, responsabilidade civil, acidentes e suporte técnico especializado.",
    icon: Plane,
    gradient: "from-pink-500 to-rose-500",
  },
  {
    title: "Seguro Bike",
    shortDesc: "Proteção contra roubo e danos.",
    fullDesc:
      "Cobertura para roubo, furto qualificado, danos acidentais e assistência para ciclistas em todo o território nacional.",
    icon: Bike,
    gradient: "from-purple-500 to-indigo-500",
  },
  {
    title: "Seguro Caminhões",
    shortDesc: "Proteção para transporte de cargas.",
    fullDesc:
      "Cobertura contra acidentes, roubo de carga, danos a terceiros e assistência 24h para transporte rodoviário.",
    icon: Truck,
    gradient: "from-emerald-500 to-teal-500",
  },
  {
    title: "Seguro Embarcações",
    shortDesc: "Proteção para barcos e lanchas.",
    fullDesc:
      "Cobertura contra danos à embarcação, responsabilidade civil, acidentes náuticos e assistência especializada.",
    icon: Anchor,
    gradient: "from-yellow-400 to-orange-500",
  },
  {
    title: "Seguro Moto",
    shortDesc: "Proteção completa para motocicletas.",
    fullDesc:
      "Cobertura contra roubo, furto, colisões e danos a terceiros, com assistência 24h para motociclistas.",
    icon: Bike,
